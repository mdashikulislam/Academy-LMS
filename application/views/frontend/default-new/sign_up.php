                ...
                <div class="card" style="background-color:#2B2C2F;color: #fff">
                    <div class="card-body" style="padding: 50px">
                        <div class="sing-up-right">
                            <h3 class="text-center"><?php echo get_phrase('Sign Up'); ?></h3>
                            <p class="text-center"><?php echo get_phrase('Explore, learn, and grow with us. Enjoy a seamless and enriching educational journey. Lets begin!') ?></p>
