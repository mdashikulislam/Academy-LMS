        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 col-sm-12 col-12 ">
                    <div class="card" style="background-color:#2B2C2F;color: #fff">
                        <div class="card-body" style="padding: 50px">
                            <div class="sing-up-right">
                                <h3 class="text-center" style="color: #fff"><?php echo get_phrase('Log In'); ?></h3>
                                <p class="text-center" style="color: #fff"><?php echo get_phrase('Explore, learn, and grow with us. Enjoy a seamless and enriching educational journey. Lets begin!') ?></p>
